...
<body>
    ...
    <div class="form-box">
        ...
        <form action="backend.php" class="login_form">
            <div class="input-box">
            ...
            <div class="input-box">
                ...
                <input id="confirmed" name="cpws" type="password" placeholder="Confirm Password" required>
            ...
            <button type="submit" class="login-btn"><a href="form.html" target="_blank
                ">Sign up</a></button>
            <div class="Signup">
